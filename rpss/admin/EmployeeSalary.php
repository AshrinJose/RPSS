...
<table width="623" height="48" border="0">
  <tr>
 	<td class="title"><span>Employee Salary</span></td>    
  </tr>
</table>
<p>&nbsp;</p>
<h4 class="title">&nbsp;</h4>
...
<table align="center">
<tr>
	<td ><label for="txtemp">EMPID :</label></td>
    <td><input type="text" name="txtemp" id="txtemp" class="form-control" required="required"/></td>
</tr>
 <tr>
    <td>Salary:</td>
    <td><input type="text" name="txtsalary" id="txtsalary" class="form-control" required="required" /></td>
  </tr>
  </table><br />
<table align="center">
  <tr>
