...
<div class="row1">
<h1 class="title">Member <span>Details</span></h1>
<p>&nbsp;</p>
</div>
...
<?php
	...
	$start_from=($page-1)*1;
	$sql="select * from tbl_personaldetails,tbl_plantation,tbl_login where tbl_personaldetails.type=2 and tbl_personaldetails.code_no=tbl_login.code_no and tbl_personaldetails.code_no=tbl_plantation.code_no limit $start_from,1";
...
<?php
	$sql="select count(type) from tbl_personaldetails where tbl_personaldetails.type=2";
	$result=mysql_query($sql);
